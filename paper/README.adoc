...
Finally, four new boards (ROCK64 <<r64>>) have been added to the cluster.
...
** NFS: it is a distributed file system protocol <<nfs>>.
...
Moreover, Duplicity is one of the most popular tools to create secure backup <<dup>>.
