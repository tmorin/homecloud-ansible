...
Those kinds of tests provides two main benefits: 1) the implemented features are tested before to reach the real life and 2) potential regressions are early identified.
